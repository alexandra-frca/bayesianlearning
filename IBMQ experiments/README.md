The notebook `IBMQ_experiments.ipynb` has some experiments on IBMQ devices using OpenPulse. Some of these experiments are meant to collect data for inference of ω, ω and T2*, T1, or T2.
